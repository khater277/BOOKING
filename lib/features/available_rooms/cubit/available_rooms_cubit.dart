...
import 'package:booking/features/available_rooms/data/models/check_rate/body/room.dart';
...
import 'package:booking/features/available_rooms/data/models/create_booking/body/room.dart';
...
class AvailableRoomsCubit extends Cubit<AvailableRoomsState> {
  ...
  static AvailableRoomsCubit get(context) => BlocProvider.of(context);
  ...
  Future<void> addBookingToFirestore({required int hotelId}) async {
    ...
    final params = AddBookingToFireStoreParams(
      bookingId: bookingId,
      userId: HiveHelper.getCurrentUser()!.uid!,
