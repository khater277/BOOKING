...
abstract class $HolderCopyWith<$Res> {
  ...
  $Res call({@HiveField(0) String? name, @HiveField(1) String? surname});
}
...
class _$_Holder implements _Holder {
  _$_Holder({@HiveField(0) this.name, @HiveField(1) this.surname});
...
abstract class _Holder implements Holder {
  factory _Holder(
      ...
      @HiveField(1) final String? surname}) = _$_Holder;
