...
import 'package:booking/features/maps/presentation/widgets/search_results/search_results.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<MapsCubit, MapsState>(
      builder: (context, state) {
        final MapsCubit cubit = MapsCubit.get(context);
        return FloatingSearchBar(
          ...
          builder: (context, transition) {
            if (cubit.floatingSearchBarController.query.isEmpty) {
              return const SizedBox();
            } else {
              return SearchResult(cubit: cubit);
            }
          },
        );
      },
